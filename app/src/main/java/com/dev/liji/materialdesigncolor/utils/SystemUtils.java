package com.dev.liji.materialdesigncolor.utils;
...
public class SystemUtils {
     ...
     * @return
     */
    public static String get2Point(int num) {
        if (num < 100) {
            return "<0.1";
        }
        BigDecimal bigDecimal = new BigDecimal(num * 1.0 / 1000);
     ...
     * @return
     */
    public static String get2Point(double num) {
        if (num < 100) {
            return "<0.1";
        }
        BigDecimal bigDecimal = new BigDecimal(num * 1.0 / 1000);
